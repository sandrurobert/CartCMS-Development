...
<form method="post" class="mainForm">
	<fieldset>
    	<div class="widget first">
  			<div class="head"><h5>Add a new gallery</h5></div>
 				<div class="rowElem nobg">
           		...
           		<div class="rowElem nobg">
                	<label>Date:</label>
                    <div class="formRight">
                    	<input type="text" name="cdate" value="{current_date}" id="cdate"/>
	...
	$(function() {  
	 $("label.error").hide();
 	 ...
 	 $("#submit").click(function() { 
		...
		$.post("{SITE_URL}/galleries/gallery_add_process", 
		       { title: $('input#title').val(), cdate: $('input#cdate').val() },
		 function(data){ 
				if (data == 'yes')
					$('div.success').html("<p style='text-align:center;'>Gallery added successfully<br /><a href='{SITE_URL}/galleries/gallery_add'>Add another gallery</a></p>");					
			});
	 return false;
 	 });  
	}); 
